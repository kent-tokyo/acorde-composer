...
対象アプリは Acorde Composer `0.1.11`、engine依存は `acorde` `1.1.2`です。コード上の回帰検証はNode 177件、Rust unit test 20件が成功していますが、これらはmacOS／Windows実機のpackaged-app QAを代替しません。
