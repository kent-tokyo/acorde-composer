...
contextBridge.exposeInMainWorld('acorde', {
  ...
  setApplicationLanguage: (language) => ipcRenderer.invoke('app:setLanguage', { language }),
  setApplicationMenuState: (state) => ipcRenderer.invoke('app:setMenuState', state),
  ...
  saveDocument: (payload) => ipcRenderer.invoke('file:saveDocument', payload),
  ...
  renderCurrent: (width, options = {}) => ipcRenderer.invoke('engine:renderCurrent', { width, ...options }),
  ...
  prepareSoundfontPlayback: (payload) => ipcRenderer.invoke('engine:prepareSoundfontPlayback', payload),
  ...
  attachResolvedSnapshot: (payload) => ipcRenderer.invoke('soundfont:attachResolvedSnapshot', payload),
  attachResolvedLayers: (payload) => ipcRenderer.invoke('soundfont:attachResolvedLayers', payload),
