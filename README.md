...
- v1→v2 release QA schema移行方針は`docs/release-qa-schema-migration.md`に固定（v2は未実装）
...
公開対象リリース：[Acorde Composer v0.1.6](https://github.com/kent-tokyo/acorde-composer/releases/tag/v0.1.6)。現在の作業ツリーでは`npm test` 99件、Rust 17件、構文・差分検証を確認しています。
