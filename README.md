...
現在のComposer engineは、隣接する `acorde` v1.0.9 の5 crateをpath依存かつversion pinして利用します。preset-zone mappingのprovider-neutral APIは利用可能ですが、実SF2/SF3 assetからのzone materializationは外部decoder/provider境界に残ります。
