...
function applyLanguage(next = language) {
  ...
  [['entry-title', editor.entry], ['entry-description', editor.entryDescription], ['pitch-label', editor.pitch], ['duration-label', editor.duration], ['add-note-button', editor.addNote], ['add-rest-button', editor.addRest], ['add-measure-button', editor.addMeasure], ['score-settings-title', editor.score], ['tempo-label', editor.tempo], ['apply-tempo-button', editor.applyTempo], ['reset-score-button', editor.reset]].forEach(([id, value]) => text(id, value));
