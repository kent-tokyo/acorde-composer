...
if (require.main === module) {
  try {
    ...
    process.stdout.write(`${JSON.stringify({ valid: result.verification.valid, ready: result.report.qa.ready, artifactReady: result.report.artifactQa?.ready === true, output: result.outputPath })}\n`);
